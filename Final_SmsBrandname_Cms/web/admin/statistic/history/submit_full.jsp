    ...
    <head>
        ...
        <script>
            ...
            function changeBrand() {
                ...
                if (selectBr.val() !== "") {
                    var cpid = selectBr.attr("user_sender");
                    var url = "/admin/statistic/ajax/list-cp.jsp?cpid=" + cpid;
                    url += "&_=" + Math.floor(Math.random() * 10000);
                    AjaxAction(url, "_userSender");
                    $("#_userSender").select2('val', cpid);
                } else {
                    var url = "/admin/statistic/ajax/list-cp.jsp?cpid=" + cpid;
                    url += "&_=" + Math.floor(Math.random() * 10000);
                    AjaxAction(url, "_userSender");
        ...
        <%
            ...
            all = logDao.getMsgSubmitLog(currentPage, maxRow, userSender, cp_code, label, type, result, provider, stRequest, endRequest, phone,
                    telco, err_code,tranId);
            int totalPage = 0;
            int totalRow = logDao.countMsgSubmitLog(userSender, cp_code, label, type, result, provider, stRequest, endRequest, phone, telco, err_code,tranId);
                            ...
                            <table id="rounded-corner" align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="rounded-q4 redBoldUp">LỊCH SỬ GỬI TIN NHẮN FULL</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select style="width: 350px" onchange="changeCP()" id="_userSender" name="userSender">
                                                ...
                                                <option user_sender="<%=oneUser.getAccID()%>" <%=(userSender.equals(oneUser.getUserName())) ? "selected ='selected'" : ""%> 
                                                        value="<%=oneUser.getUserName()%>" img-data="<%=(oneUser.getStatus() == 1 ? "" : "/admin/resource/images/lock1.png")%>" >[<%=oneUser.getUserName()%>] <%=oneUser.getFullName()%></option>
                                                <%}%>
                                            </select>
                                            &nbsp;&nbsp;
                                            Hướng gửi
                                            ...
                                            <select style="width: 250px" id="_provider" name="provider">
                                                ...
                                                <option <%=(provider.equals(one.getCode())) ? "selected ='selected'" : ""%> 
                                                    value="<%=one.getCode()%>" 
                                                    img-data="<%=(one.getStatus() == 1 ? "" : "/admin/resource/images/lock1.png")%>" ><%=one.getName()%></option>
                                                <%
                                                    }
                                                %>
                                            </select>
                                            ...
                                            Mã Lỗi:
                                            &nbsp;&nbsp;
                                            <input size="4" name="err_code" type="text">
                                        </td>
                                    </tr>
                                    <tr align="center">
                                        <td colspan="3">
                        ...
                        <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="boder_right"><%=DateProc.Timestamp2DDMMYYYYHH24MiSS(oneBrand.getTimeSend())%></td>
