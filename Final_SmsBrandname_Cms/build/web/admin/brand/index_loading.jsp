...
//                    }
    ...
    <body>
        <%
            ...
            int status = RequestTool.getInt(request, "status", 3);
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        <!-- Tìm kiếm-->
                        <form action="<%=request.getContextPath() + "/admin/brand/index_loading.jsp"%>" method="post">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            Trạng thái:
                                            <select name="status">
                                                <option <%=(status == 3 ? "selected='selected'" : "")%> value="3">Đang duyệt</option>
                                            </select>
                                            &nbsp;&nbsp;&nbsp;
...
//                                                    for (let el of document.querySelectorAll('.dt'+name)) el.style.display = 'none';
                                        ...
                                        <td class="boder_right" align="center">
                                            <span style='color: blue;font-weight: bold'>Đang duyệt</span>
                                        </td>
