    ...
    <ul>
        ...
        <li><a href="#"><b>Quản lý BRand</b></a>
            <ul>
                ...
                <!--<li><a target="_parent" href="<%=request.getContextPath()%>/admin/brand/index_loading.jsp" title="">Brand Name Processing</a></li>-->
                <!--<li><a target="_parent" href="<%=request.getContextPath()%>/admin/brand/index_wait.jsp" title="">Brand Name Pending</a></li>-->
                ...
                <li><a target="_parent" href="<%=request.getContextPath()%>/admin/phone-blacklist/index.jsp" title="">Số Blacklist</a></li>
                    <%}%>
                <% if (userlogin.checkRight("/admin/phone-blacklist/", Permission.PER.VIEW.val)) {%>
                <li><a target="_parent" href="<%=request.getContextPath()%>/admin/template_sms/index.jsp" title="">Tin nhắn mẫu</a></li>
                    <%}%>
                <% if (userlogin.checkRight("/admin/phone-blacklist/", Permission.PER.VIEW.val)) {%>
                <li><a target="_parent" href="<%=request.getContextPath()%>/admin/template_sms/list_acc_temp.jsp" title="">Cấp tin nhắn mẫu</a></li>
                    <%}%>
