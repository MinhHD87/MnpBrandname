            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        <!-- Tìm kiếm-->
                        <form action="<%=request.getContextPath() + "/admin/brand/index_wait.jsp"%>" method="post">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            Trạng thái:
                                            <select name="status">
                                                <option <%=(status == 2 ? "selected='selected'" : "")%> value="2">Chưa duyệt</option>
                                            </select>
                                            &nbsp;&nbsp;&nbsp;
                            ...
                            <table style="font-size: 11px" id="_dataTable" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="" class="boder_right" style="width: 180px" align="left">
                                            <%
